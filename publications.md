...
## TITLE: Runtime methods for  automatic behavioral stratification of scientific codes
- DOI: ?
...
## TITLE: Evaluation of a Workflow Scheduler Using Integrated Performance Modeling and Batch Queue Wait Time Prediction,
...
## TITLE: Grid Portals for Bioinformatics
- DOI: ?
...
## TITLE: Performance engineering: Understanding and improving the performance of large-scale codes
- DOI: ?
...
## TITLE: Building the Bioscience Gateway, Science Gateways: Common Community Interfaces to Grid Resources,
- DOI: ?
...
## TITLE: Qualitative performance characteristics of large-scale scientific workflows executing on the TeraGrid
- DOI: ?
...
## TITLE: An open framework for scalable, reconﬁgurable analysis
- DOI: ?
...
## TITLE: Association between single nucleotide polymorphisms in the cannabinoid receptor gene (CNR1) and impulsivity in southwest California Indians
...
## TITLE: Heritability of illicit drug use and transition to dependence in Southwest California Indians
...
## TITLE: Gene-lifecourse interaction for alcohol consumption in adolescence and young adulthood: Five monoamine genes
...
## TITLE: Approaches That Work: How Authentic Learning is Transforming Higher Education.
- DOI: ?
- CITATION: Lombardi, M. M., “Approaches That Work: How Authentic Learning is Transforming Higher Education.”  EDUCAUSE. July 2007.

## TITLE: Gateway to the TeraGrid for Bio-Scientists: A Tutorial. What does it do? How is it used in course curricula? How was it constructed?
- DOI: ?
...
## TITLE: Quantitative effects of common genetic variations in the 3’UTR of the human LDL-receptor gene and their associations with plasma lipid levels in the Atherosclerosis Risk  in Communities study
...
## TITLE: Bridging Teaching, Learning, and Education in Grid-enabled Bioinformatics
- DOI: ?
...
## TITLE: Finding prokaryotic ion channels
- DOI: ?
...
## TITLE: Visualization and the Larger World of Computer Graphics: What’s Happening Out There?
- DOI: ?
...
## TITLE: Genetic and environmental sources of variation in heart rate response to infused nicotine in twins 
...
## TITLE: MotifNetwork: A Grid-enabled Workflow for High-throughput Domain-centered Analysis of Biological Sequences
- DOI: ?
...
## TITLE: A Composition Algorithm for the {SILO} Cross-Layer Optimization Service Architecture
- DOI: ?
...
## TITLE: Stormy weather: grid computing powers fine-scale climate modeling
- DOI: ?
...
## TITLE: Analysis of Application Heartbeats: Learning Structural and Temporal Features in Time Series Data for Identification of Performance Problems Under submission
...
## TITLE: Externalizing disorders in American Indians:  Comorbidity and a genome wide linkage analysis
...
## TITLE: Visualization and Analysis of Microstructure in Three-Dimensional Discrete Numerical Models
...
## TITLE: Traffic Grooming for Optical Networks: Foundations, Techniques and Frontiers
- DOI: ?
...
## TITLE: NC-FIRST: Weather Information and Training for North Carolina Emergency Managers
- DOI: ?
...
## TITLE: Mobile Micro Rain Radar Deployments in North Carolina
- DOI: ?
...
## TITLE: Federation of Rule-Based Data Grids
- DOI: ?
...
## TITLE:  High-throughput sialylmotif analysis in the glycosyltransferase protein family
- DOI: ?
...
## TITLE: 10.1093/bioinformatics/btn656 
...
## TITLE: Building Solutions for Researchers with a Science Gateway
- DOI: ?
...
## TITLE: Data vases: Plots for visualizing multiple time series
- DOI: ?
...
## TITLE: Dynamic provisioning system for bandwidth-scalable core optical network
...
## TITLE:  Grid information retrieval
- DOI: ?
- CITATION: Nassar, N.  Grid information retrieval. Open Grid Forum. Chapel Hill, NC, May, 2009.

## TITLE: Information visualization services in a library? A public health case study
...
## TITLE: Large tree visualization of the melanoma genome
- DOI: ?
...
## TITLE: TeraGrid’s integrated information service
...
## TITLE: Traffic grooming: A changing role in green optical networks
...
## TITLE: Visual analytics approach to practice evidence-based medicine
- DOI: ?
...
## TITLE: Visualizing all of iBiblio’s historic weblogs
- DOI: ?
...
## TITLE: Transcontinental preservation archive prototype
- DOI: ?
...
## TITLE: Management of very large distributed shared collections
...
## TITLE: Universal view and open policy: characteristics of large-scale data management system
...
## TITLE: Algorithms and performance measurements for MotifNetwork analysis programs
- DOI: ?
...
## TITLE: In silico construction of a protein interaction landscape for nucleotide excision repair
...
## TITLE: A service-oriented interface to the iRODS data grid
- DOI: 
...
## TITLE: Age at regular drinking, clinical course, and heritability of alcohol dependence in the San Francisco family study: A gender analysis
- DOI: 
...
## TITLE: An open source option for cloud computing in education and research
- DOI: 
...
## TITLE: Antipsychotic-induced vacuous chewing movements and extrapyramidal side effects are highly heritable in mice
- DOI: 
...
## TITLE: Association between harmful alcohol consumption behavior and dopamine transporter (DAT1) gene polymorphisms in a male Finnish population
- DOI: 
...
## TITLE: Cannabis dependence in the San Francisco Family Study: Age of onset of use, DSM-IV symptoms, withdrawal, and heritability
- DOI: 
...
## TITLE: Cloud computing and software services: Theory and techniques (1st ed.)
- DOI: 
...
## TITLE: Cloud Network Infrastructure as a Service: An exercise in multi-domain orchestration
- DOI: 
...
## TITLE: Collaborative data curation
- DOI: 
- CITATION: Nassar, N. Collaborative data curation.  UNC BarCamp 2010. Chapel Hill, NC, June, 2010.

## TITLE: Creating an open web 2.0 cloud e-Learning experience
- DOI: 
...
## TITLE: Cyber infrastructure for community remote sensing
- DOI: 
...
## TITLE: Data approaches for campus bridging
- DOI: 
...
## TITLE: Domain-based identification and analysis of glutamate receptor ion channels and their relatives in prokaryotes
...
## TITLE: EEG spectral phenotypes: Heritability and association with marijuana and alcohol dependence in an American Indian community study
- DOI: 
...
## TITLE: Exploration of polymer conformational similarities in polymer-carbon nanotube interfaces
- DOI: 
...
## TITLE: Genome-wide scan for self-rating of the effects of alcohol in American Indians
- DOI: 
...
## TITLE: Heritability of MMPI-2 scales in the UCSF family alcoholism study
- DOI: 
...
## TITLE: High performance computing instrumentation and research productivity in U.S. universities
- DOI: 
...
## TITLE: Identifying prokaryotic counterparts of HCN and CNG channels by use of an evolutionary domain network
- DOI: 
...
## TITLE: Policies and Interoperability of Digital Repositories Workshop
- DOI: 
...
## TITLE: iRODS: Data sharing technology integrating communities of practice
- DOI: 
...
## TITLE: Linkage analyses of cannabis dependence, craving, and withdrawal in the San Francisco family study
- DOI: 
...
## TITLE: Linkage scan of nicotine dependence in the University of California, San Francisco (UCSF) family alcoholism study
- DOI: 
...
## TITLE: PowerMon: Fine-grain and intergrated power monitoring for commodity computer systems
- DOI: 
...
## TITLE: Precalculated protein structure alignments at the RCSB PDB website
- DOI: 
...
## TITLE: Programming environment and architecture for situational awareness and response
- DOI: 
...
## TITLE: RCRTool: Design Document; Version 0.1. RENCI Technical Report TR-10-01
- DOI: 
...
## TITLE: The Geographic Awareness Tool: Techniques for geo-encoding digital library content
- DOI: 
...
## TITLE: The social computing room: A multipurpose collaborative visualization environment
- DOI: 
...
## TITLE: TUCASI data infrastructure project
- DOI: 
...
## TITLE: Understanding data management plans and funder requirements
- DOI: 
...
## TITLE: Use of social media and memex approaches to address issues of information overload and fragmentation for students in the STEM disciplines
- DOI: 
...
## TITLE: Visual discoveries: Understanding social and economic factors using visual-analytical tools
- DOI: 
...
## TITLE: Visual-analytics tools for analyzing polymer conformational dynamics
- DOI: 
...
## TITLE: ?
- DOI: 
- CITATION: Spanlang, B., Normand, J.M., Borland, D., Kilteni, K., Giannopoulos, E., Pomes, A., Gonzalez-Franco, M., Perez-Marcos, D., Arroyo-Palacios, J., Muncunill, X.N., Slater, M. How to build an embodiment lab: Achieving body representation illusions in virtual reality. (2014). Frontiers in Robotics and AI. 1(9).

## TITLE: ?
- DOI: 
- CITATION: Tarboton, D., Idaszak, R., Horsburgh, J., Stealey, M., Yi, H., Ames, D., Goodall, J. Band, L., Merwade, V., Couch, A., Hooper, R., Valentine, D., Maidment, D. HydroShare: Advancing collaboration through hydrologic data and model sharing. 2014 Annual Water Resources Conference. Tysons Corner, VA, USA, November 6, 2014.

## TITLE: ?
- DOI: 
- CITATION: Tarboton, D. G., Idaszak, R., Horsburgh, J.S., Heard, J., Ames, D, Goodall, J.L., Band, L., Merwade, V., Couch, A., Arrigo, J., Hooper, R., Valentine, D. Maidment, D. (2014). HydroShare: Advancing collaboration through hydrologic data and model sharing. 7th International Congress on Environmental Modeling and Software, ed. D. Ames and N. Quinn. San Diego, California, USA, International Environmental Modeling and Software Society (iEMSs).

## TITLE: ?
- DOI: 
- CITATION: West, V.L., Borland, D., Hammond, W.E. Innovative information visualization of electronic health record data: A systematic review. (2014). Journal of the American Medical Informatics Association.

## TITLE: ?
- DOI: 
- CITATION: Yi, H., Rasquin, M., Mishra, A.V., Fang, J., Bolotnov, In-Situ processing and visualization for direct numerical simulation of coolant flow through mixing vanes. I.A. Proceedings of 2014 International Congress on Advances in Nuclear Power Plants (ICAPP). Paper No. 14291. Charlotte, North Carolina, USA, April 6-9, 2014.

## TITLE: ?
- DOI: 
- CITATION: Lenhardt, W.C., Ahalt, S., Jones, M., Aukema, J., Hampton, S., Hespanh, S.R., Idaszak, R., Schildhauer, M. ISEES-WSSI Lessons for sustainable science software from an early career training institute on open science synthesis. 2nd Workshop on Sustainable Software for Science: Practice and Experiences (WSSSPE2). New Orleans, LA, USA, November 16. 2014.

## TITLE: ?
- DOI: 
- CITATION: Mandal, A., Ruth, P., Baldin, I., Xin, Y., Castillo, C., Rynge, M., Deelman, E. Leveraging and adapting ExoGENI infrastructure for data-driven domain science workflows. Proceedings of 3rd GENI Research and Educational Experiment Workshop. March 2014. (to appear).

## TITLE: ?
- DOI: 
- CITATION: Xin, Y., Baldin, I., Chase, J., Ogan, K. Leveraging semantic web technologies for managing resources in a multi-domain infrastructure-as-a-service environment. (2014). arXiv.

## TITLE: ?
- DOI: 
- CITATION: Tilson, J., Ermler, W.C. (2014). Massively parallel spin orbit configuration interaction. Theoretical Chemistry Accounts. DOI 10.1007/s00214-014-1564-8. (To Appear)

## TITLE: ?
- DOI: 
- CITATION: Grant, R.E., Olivier, S.L., Laros III, J.H., Porterfield, A., Brightwell, R. Metrics for evaluating energy saving techniques for resilient HPC systems. Workshop on High Performance Power Aware Computing (HPPAC). Phoenix, AZ, USA, June 2014.

## TITLE: ?
- DOI: 
- CITATION: Borland, D., West, V.L., Hammond, W.E. Multivariate visualization of system-wide National Health Service data using radial coordinates. Proceedings of the 2014 Workshop on Visual Analytics in Healthcare (VAHC 2014). Washington, DC, USA, November 15, 2014.

## TITLE: ?
- DOI: 
- CITATION: Baru, C., Lander, H., Rajasekar, A., Zhan, J. National data science laboratory: An experimental benchmarking architecture. National Institute of Standards and Technology Data Science Symposium. Gaithersburg, MD, USA, March 4-5, 2014.

## TITLE: ?
- DOI: 10.1016/j.biopsych.2014.05.023
- CITATION: Cannon, T.D., Chung, Y., He, G., Sun, D., Jacobson, A., van Erp, T.G., McEwen, S., Addington, J., Bearden, C.E., Cadenhead, K., Cornblatt, B., Mathalon, D.H., McGlashan, T., Perkins, D., Jeffries, C., Seidman, L.J., Tsuang, M., Walker, E., Woods, S.W., Heinssen, R. (2014). Progressive reduction in cortical thickness as psychosis develops: A multisite longitudinal neuroimaging study of youth at elevated clinical risk. Biological - Psychiatry. pii: S0006-3223(14)00414-4. doi: 10.1016/j.biopsych.2014.05.023. [Epub ahead of print]

## TITLE: ?
- DOI: 
- CITATION: Xin, Y., Baldin, I., Heerman, C., Mandal, A., Ruth, P. Scaling up applications over distributed clouds with dynamic layer-2 exchange and broadcast service. ITC’26 Workshop on Federated Future Internet and Distributed Cloud Testbeds (FIDC). Karlskrona, Sweden, September 12, 2014.

## TITLE: ?
- DOI: 
- CITATION: Li, A., Chall, S., Lu, W., Vorderstrasse, A., Johnson, C. The challenges of disparate data formats: Analysis and visualization in the SLIDES project. American Medical Informatics Association (AMIA) 2014 Annual Symposium. Washington, DC, USA, November 15-19, 2014.

## TITLE: ?
- DOI: 
- CITATION: Sankaran, S., Yi, H., Cherry, M. The REACH NC Resource Finder: A multi-institutional, statewide implementation of eagle-i. VIVO/SciTS 2014 Conference. Austin, TX, USA, August 6-8.

## TITLE: ?
- DOI: 
- CITATION: Perkins, D.O., Jeffries, C.D., Addington, J., Bearden, C.E., Cadenhead, K.S., Cannon, T.D., Cornblatt, B.A., Mathalon, D.H., McGlashan, T.H., Seidman, L.J., Tsuang, M.T., Walker, E.F., Woods, S.W., Heinssen, R. (2014). Towards a psychosis risk blood diagnostic for persons experiencing high-risk symptoms: Preliminary results from the NAPLS project. Schizophrenia Bulletin. pii: sbu099. [Epub ahead of print]

## TITLE: ?
- DOI: 
- CITATION: Peck, T., Borland, D. Virtual embodiment: Implications and applications of self-avatars in immersive virtual environments. Living Environments Laboratory. Wisconsin Institute for Discovery at the University of Wisconsin-Madison, May 13, 2014.

## TITLE: ?
- DOI: 
- CITATION: Shoffner, M. Toward integrated security in cloud based data and compute infrastructures. Tutorial, ASE CyberSecurity 2014. Stanford, CA, USA, May 27-31, 2014.

## TITLE: ?
- DOI: 
- CITATION: Borland, D. Visualization of health informatics data. Duke University Visualization Friday Forum. Durham, NC, USA, April 4, 2014.

## TITLE: ?
- DOI: 
- CITATION: Lynch, D., Borland, D., Kopper, R., and Peck, T. (2014). Volume visualization on a WIM: Design considerations and planned evaluations. IEEE Virtual Reality 2014 Workshop on Immersive Volumetric Interaction (WIVI). Minneapolis, MN, USA. March 29, 2014.

## TITLE: ?
- DOI: 
- CITATION: Ahalt, S., Band, L., Christopherson, L., Idaszak, R., Lenhardt, C., Minsker, B., Palmer, M., Shelley, M., Tiemann, M., & Zimmerman, A. (2014). Water Science Software Institute: Agile and open source scientific software development. IEEE Computing in Science and Engineering.

# 2015

## TITLE: ?
- DOI: 
- CITATION: Jiang, F., Castillo, C., Schmitt, C., Mandal, A., Ruth, P., and Baldin, I. Enabling Workflow Repeatability with Virtualization Support. 2015.

## TITLE: ?
- DOI: 
- CITATION: Krishnamurthy, A. Complex Data for Health Services Research. Sheps Center for Health Services Research. 2015.

## TITLE: ?
- DOI: 
- CITATION: Krishnamurthy, A. Data Linkages, Data Sharing and Data Mining for CER. CER Symposium: Building Bridges to Advance CER. RTP. May 2015.

## TITLE: ?
- DOI: 
- CITATION: Krishnamurthy, A. The National Consortium for Data Science. Oak Ridge Associated universities Annual Meeting with a focus on Big Data. 2015.

## TITLE: ?
- DOI: 
- CITATION: Krishnamurthy, A. & Alluru, S. The NSF South Big Data Regional Innovation Hub. IEEE International Conference on Big Data. Santa Clara, CA. 2015.

## TITLE: ?
- DOI: 
- CITATION: Timmes, F., Ahalt, S., Turk, M., Idaszak, R., Schildauer, M., Brower, R., Lenhardt, C., Gustafson, K. 2015 Software Infrastructure for Sustained Innovation (SI2) Principal Investigators Workshop Report. 2015 Software Infrastructure for Sustained Innovation (SI2) Principal Investigators Workshop. 2015.

## TITLE: ?
- DOI: 
- CITATION: Xu, H., Coposky, J., Bedard, D., Ward, J., Russell, T., Rajasekar, A., Moore, R., Keller, B., Greer, Z. A Method for the Systematic Generation of Audit Logs in a Digital Preservation Environment and Its Experimental Implementation in a Production Ready System. iPres 2015. 2015.

## TITLE: ?
- DOI: 
- CITATION: Ruth, P., Mandal, A., Castillo, C., Fowler, R., Tilson, J., Baldin, I., Xin, Y. Achieving Performance Isolation on Multi-Tenant Networked Clouds Using Advanced Block Storage Mechanisms. 2015.

## TITLE: ?
- DOI: 
- CITATION: Mandal, A., Ruth, P., Baldin, I., Xin, Y., Castillo, C., Juve, G., Rynge, M., Deelman, E., Chase, J. Adapting Scientific Workflows on Networked Clouds Using Proactive Introspection. IEEE/ACM 8th International Conference on Utility and Cloud Computing, December 2015.

## TITLE: ?
- DOI: 
- CITATION: Young, J.W., Benedict, K., Lenhardt, W.C. Agile Data Curation: A conceptual framework and approach for practitioner data management. 2015 Fall Meeting, AGU. San Francisco, CA. December 14-18, 2015.

## TITLE: ?
- DOI: 
- CITATION: West, V.L., Borland, D., West, D., Hammond, W.E. An evaluation of machine learning methods and visualization of results to characterize large healthcare document collections. 2015 Annual Meeting of the Decisions Sciences Institute. 2015.

## TITLE: ?
- DOI: 
- CITATION: Vicory, J., Couture, H.D., Thomas, N.E., Borland, D., Marron, J.S., Woosley, J., Niethammer, M. Appearance normalization of histology slides. Computerized Medical Imaging and Graphics. 2015.

## TITLE: ?
- DOI: 
- CITATION: Porterfield, A., Fowler, R., Bhalachaundra, S., Rountree, B., Deb, D., Lewis, R., Blanton, B. Application Runtime Variability and Power Optimization for Exascale Computers. International Workshop on Runtime and Operating Systems for Supercomputers. Portland, Oregon. June 2015.

## TITLE: ?
- DOI: 
- CITATION: Bedard, D. BoF: Challenges of Data Management at Scale. BoF Session at DDN-Sponsored Workshop. 2015.

## TITLE: ?
- DOI: 
- CITATION: Barber, R., Philips, N.R., Tilson, J.L., Huebinger, R.M., Shewale, S.J., Koenig, J.L., Mitchel, J.S., O’Bryant, S.E., Waring, S.C., Diaz-Arrastia, R., Chasse, S., Wilhelmsen, K.C. Can Genetic Analysis of Putative Blood Alzheimer’s Disease Biomarkers Lead to Identification of Susceptibility Loci? 2015.

## TITLE: ?
- DOI: 
- CITATION: Borland, D., Moreland, K., Rogowitz, B., Samsel, F., Stone, M., Brewer, C. Color Mapping in VIS: Persepctives on Optimal Solutions. 2015

## TITLE: ?
- DOI: 
- CITATION: Downs, R.R., Lenhardt, W.C., Robinson, E., Davis, E., Weber, N. Community Recommendations for Sustainable Scientific Software. Journal of Open Research Software 3; e11. 2015.

## TITLE: ?
- DOI: 
- CITATION: Zhang, J., Nabavi, S., Chakrabortty, A., Xin, Y. Convergence Analysis of ADMM Based Power System Mode Estimation Under Asynchronous Wide-Area Communication Delays. EEE PES General Meeting. Denver, Colorado. July 2015.

## TITLE: ?
- DOI: 
- CITATION: Calloway, C.B. Cython: A C Generator for Python. 2015.

## TITLE: ?
- DOI: 
- CITATION: Russell, T. Data Management for Grown Ups. All Things Open 2015. 2015.

## TITLE: ?
- DOI: 
- CITATION: Lander, H. & Rajasekar, A. DataBridge: Creating Bridges to Find Dark Data. Chapel Hill, NC. 2015.

## TITLE: ?
- DOI: 
- CITATION: Moore, R., Rajasekar, A., Xu, H. DataNet Federation Consortium Policy Toolkits. iPRES Conference. November 2015.

## TITLE: ?
- DOI: 
- CITATION: Zhang, T. & Xin, Y. Designing a Strategy-Proof Online Auction Mechanism for Deadline Aware Cloud Resource Allocation. RENCI Technical Report. October 2015.

## TITLE: ?
- DOI: 
- CITATION: Bhalachandra, S., Porterfield, A., Prins, J. Duty Cycle Modulation to Improve Energy Efficiency in High Performance Computing. 11th Workshop on High-Performance, Power-Aware Computing. Hyderabad, India. May 2015.

## TITLE: ?
- DOI: 
- CITATION: Thakur, S., Jones, P., Cox, S. Enabling Self-Awareness for Knowledge Workers Through Visualization of Instrumentation Data. 2015 Workshops at IEEE Vis conference. Chicago, IL. October 2015.

## TITLE: ?
- DOI: 
- CITATION: Jiang, F., Castillo, C., Schmitt, C., Mandal, A., Ruth, P., Baldin, I. Enabling Workflow Repeatability with Virtualization Support. Workflows in Support of Large-Scale Science at Supercomputing. Austin, Texas. 2015.

## TITLE: ?
- DOI: 
- CITATION: Worth, S., Bedard, D., Combes, P. Expanding the Face of Metadata in Next Generation Sequencing. EMC-sponsored webinar. 2015.

## TITLE: ?
- DOI: 
- CITATION: Qian, T., Mueller, F., Xin, Y. Hybrid EDF Packet Scheduling for Real-Time Distributed Systems. Euromicro Conference on Real-Time Systems. July 2015.

## TITLE: ?
- DOI: 
- CITATION: Horburgh, J.s., Morsy, M.M., Castronova, A.M., Goodall, J.L., Gan, T., Yi, H., Stealey, M.J., Tarboton, D.G. Hydroshare: Sharing Diverse Environmental Data Types and Models as Social Objects with Application to the Hydrology Domain. 2015.

## TITLE: ?
- DOI: 
- CITATION: Lee, K., Berg, J.S., Milko, L., Crooks, K., Lu, M., Bizon, C., Owen, P., Wilhelmsen, K.C., Weck, K.E., Evans, J.P., Garg, S. Implementing Exome Sequencing for Retinal Dystrophies. High Diagnostic Yield of Whole Exome Sequencing in Participants with Retinal Dystrophies in a Clinical Ophthalmology Setting, American Journal of Ophthalmology. 2015.

## TITLE: ?
- DOI: 
- CITATION: Minogue, J., Borland, D., Russo, M., Chen, S.T., Grady, R. Investigating the influence of haptic technology on upper elementary students’ reasoning about sinking & floating. National Association of Research in Science Teaching (NARST) Annual International Conference. April 2015.

## TITLE: ?
- DOI: 
- CITATION: Bedard, D., Coposky, J., Russell, T., de Torcy, A., James, J., Keller, B., Greer, Z., Garde, C. iRODS 4.1. iRODS Consortium – The integrated Rule-Oriented Data System. May 2015.

## TITLE: ?
- DOI: 
- CITATION: Russell, T., Keller, B. iRODS Cloud Infrastructure and Testing Framework. iRODS UGM 2015. 

## TITLE: ?
- DOI: 
- CITATION: Reilly, J., Ahalt, S., McGee, J., Owen, P., Schmitt, C., Wilhelmsen, K. MaPSeq, A Service-Oriented Architecture for Genomics Research within an Academic Biomedical Research Institution. 2015.

## TITLE: ?
- DOI: 
- CITATION: Ahalt, S., Carsey, T., Couch, A., Hooper, R., Ibanz, L., Idaszak, R., Jones, M.B., Lin, J., Robinson, E. NSF Workshop on Supporting Scientific Discovery through Norms and Practices for Software and Data Citation and Attribution. April 2015.

## TITLE: ?
- DOI: 
- CITATION: Deelman, E., Carothers, C., Mandal, A., Tierney, B., Vetter, J.S., Bladin, I., Castillo, C., Juve, G., Krol, D., Lynch, V., Mayer, B., Meredith, J., Proffen, T., Ruth, P., Silva, R. PANORAMA: An Approach to Performance Modeling and Diagnosis of Extreme Scale Workflows. International Journal of High Performance Computing Applications. July 14, 2015.

## TITLE: ?
- DOI: 
- CITATION: Xu, H., Coposky, J., Keller, B., Russell, T. Pluggable Rule Engine Architecture. iRODS UGM 2015. June 2015.

## TITLE: ?
- DOI: 
- CITATION: Chen, S.Y., Conway, M., Crabtree, J., Lee, C., Misra, S., Moore, R., Rajasekar, A., Russell, T., Simmons, I., Stillwell, L., Tibbo, H., Xu, H. Policy Examples Workbook. iRODS Consortium. 2015.

## TITLE: ?
- DOI: 
- CITATION: Chen, S.Y., Conway, M., Crabtree, J., Lee, C., Misra, S., Moore, R., Rajasekar, A., Russell, T., Simmons, I., Stillwell, L., Tibbo, H., Xu, H. Policy Templates Workbook. iRODS Consortium. 2015.

## TITLE: ?
- DOI: 
- CITATION: Fellinger, D., Moore, R., Xu, H. Policy-based Data Management: The Future of Reproducible Data-Driven Research. American Laboratory. March 18, 2015.

## TITLE: ?
- DOI: 
- CITATION: Moore, R., Stotzka, R., Cacciari, C., Benedikt, P. Practical Policy Implementations. Research Data Alliance Technical Report, Practical Policy Working Group. February 2015.
...
## TITLE: ?
- DOI: 
- CITATION: DeTorcy, A. Python iRODS Client. December 12, 2015.

## TITLE: ?
- DOI: 
- CITATION: James, J. R iRODS Client. December 12, 2015.

## TITLE: ?
- DOI: 
- CITATION: Xin, Y., Shayman, M., La, R. Reconfiguration of Survivable IP over WDM Networks. Journal of Optical Switching and Networking. November 21, 2015.

## TITLE: ?
- DOI: 
- CITATION: Lenhardt, W., Reference Data Layers for Earth and Environmental Science: History, Frameworks, Science Needs, Approaches, and New Technologies. 2015 Fall Meeting, AGU. San Francisco, CA. December 14-18, 2015.

## TITLE: ?
- DOI: 
- CITATION: Thakur, S., Schmitt, C., Feldman, M., Lowe, N.J. RTP-Vis: Visualizing Ecosystem of Companies and Founders in Research Triangle Area. BusinessVis Workshop 2015 at IEEE Vis conference. October 2015.

## TITLE: ?
- DOI: 
- CITATION: Schmitt, C., Cox, S., Fecho, K., Idaszak, R., Lander, H., Rajasekar, A., Thakur, S. Scientific Discovery in the Era of Big Data: More than the Scientific Method. RENCI, University of North Carolina at Chapel Hill. 2015.

## TITLE: ?
- DOI: 
- CITATION: Xin, Y., Shayman, M., La, R. Reconfiguration of Survivable IP over WDM Networks. Journal of Optical Switching and Networking. 2015.
...
## TITLE: ?
- DOI: 
- CITATION: Perkins, D.O., Jeffries, C.D., Cornblatt, B.A., Woods, S.W., Addington, J., Bearden, C.E., Cadenhead, K.S., Cannon, T.D., Heinssen, R., Mathalon, D.H., Seidman, L.J., Tsuang, M.T., Walker, E.F., McGlashan, T.H. Severity of thought disorder predicts psychosis in persons at clinical high-risk. 2015.

## TITLE: ?
- DOI: 
- CITATION: Ahalt, S.C., South Big Data Hub All Hands Meeting. South Big Data Hubs Al Hands Meeting, breakout sessions, introduction to the SBDH presentation. Atlanta, GA. December 2015.

## TITLE: ?
- DOI: 
- CITATION: Lander, H., Rajasekar, A. The DataBridge: A Social Network for Data From The Long Tail of Science. 2015.

## TITLE: ?
- DOI: 
- CITATION: Rajasekar, A., Russell, T., Coposky, J., de Torcy, A., Xu, H., Wan, M., Moore, R., Schroeder, W., Chen, S.Y., Conway, M., Ward, J. The integrated Rule-Oriented Data Systems (iRODS 4.0) Micro-service Workbook. iRODS Consortium. 2015.

## TITLE: ?
- DOI: 
- CITATION: Willner, A., Papagianni, C., Giatili, M., Morsey, M., Grosso, P., Al-Hazmi, Y., Baldin, I. The Open-Multinet Upper Ontology – Towards the Semantic-based Management of Federated Infrastructures. 2015.

## TITLE: ?
- DOI: 
- CITATION: Ahalt, S., Berriman, B., Brown, M., Carver, J., Hong, N.C., Fish, A., Idaszak, R., Newman, G., Panda, D., Patra, A., Puckett, E.G., Roland, C., Thain, D., Uluagac, S., Zhang, B. Toward a Framework for Evaluating Software Success: A Proposed First Step. CSESP Challenges workshop. 2015.

## TITLE: ?
- DOI: 
- CITATION: Zhang, T., Xin, Y. Towards Designing a Truthful Online Auction Framework for Deadline-aware Cloud Resource Provisioning. 3rd Workshop on Distributed Cloud Computing. Portland, OR. June 2015.

## TITLE: ?
- DOI: 
- CITATION: Bhalachandra, S., Porterfield, A., Prins, J. Using Dynamic Duty Cycle Modulation to Improve Energy Efficiency in High Performance Computing. The 11th Workshop on High-Performance, Power-Aware Computing. Hyderabad, India. 2015.

## TITLE: ?
- DOI: 
- CITATION: Wang, W., Porterfield, A., Cavazos, J., Bhalachandra, S. Using Per-Loop CPU Clock Modulation for Energy Efficiency in OpenMP Applications. 44th International Conference on Parallel Processing (ICPP). Beijing, China. September 1-4, 2015.

## TITLE: ?
- DOI: 
- CITATION: West, V., Borland, D. Visualization of health care data. Duke Clinical Research Institute, Clinical Research Informatics Monthly Forum. August 26, 2015.
...
## TITLE: ?
- DOI: 
- CITATION: Allen, G., Chen, E., Idaszak, R., Katz, D. (2016) Report on software metrics for research software. http://ceur-ws.org/Vol-1686/. 

## TITLE: ?
- DOI: 
- CITATION: Baldin, I., Chase, J., Xin, Y., Mandal, A., Ruth, P, Cstillo, C., Orlikowski, V., Heermann, C., and Mills, J. (2016) The GENI Book: ExoGENI: A Multi-Domain Infrastructure-As-A-Service Testbed.
...
## TITLE: ?
- DOI: 
- CITATION: Borland, D., Chartier, T., and Peck, T. (2016) Pixar’s Linear Algebra. The Bulletin of the International Linear Algebra Society. 
